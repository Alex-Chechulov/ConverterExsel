...
namespace TestConverter
{
    class Program
    {
        ...
        static void tester()
        {
            ...
            {
                string test_ansver = converter.Converter((string)test[i][0], (DateTime)test[i][1], (DateTime)test[i][2], (string)test[i][3], (string)test[i][4], (string)test[i][5]+"_"+i, (string)test[i][6], (string)test[i][7]);
